...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "connect-src 'self' http://localhost:3002 http://localhost:3000 http://127.0.0.1:3000 http://127.0.0.1:3002  https://api.drgauriagarwal.com https://devapi.drgauriagarwal.com https://dashboard.drgauriagarwal.com/",
